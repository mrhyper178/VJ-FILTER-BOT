...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '807374433').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001504894460').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://leecher:leecher@cluster0.606mkpi.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002117688872'))
...
URL = "https://autofilterbot-6izz.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://autofilterbot-6izz.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://autofilterbot-6izz.onrender.com/".format(FQDN)
else:
    URL = "https://autofilterbot-6izz.onrender.com/".format(FQDN)
